    ...
    public static void main(String[] args) throws FalhaException {
        ...
        while (inputUsuario != 0) {
            ...
            if (inputUsuario == 1) {
                ...
                try {
                    if (agenda.size() == 10) {
                        throw new FalhaException("Agenda cheia! Não há mais horários disponíveis.");
                    }
                ...
                try {
                    ...
                    else throw new FalhaException("Tipo de animal inválido!");
                ...
                try {
                    ...
                    if (atendimento == 1) tipoAtendimento = "Banho";
                        ...
                        try {
                            ...
                            if ((doenca!= 1) & (doenca!= 2) & (doenca!= 3) & (doenca!= 4) & (doenca!= 5) & (doenca!= 6) & (doenca!= 7)){
                                throw new FalhaException("Doença inválida!");
                            }
                            tipoDoenca = animalParaCadastrar.returnDoenca(doenca);
                    ...
                    } else throw new FalhaException("Atendimento inválido!");
