...
public class Main {
  ...
  public static void main(String[] args) {
    while (true) {
      String[] opcoes = {"Listar Consultas", "Cadastrar Consulta", "Sair", "Limpar Consultas"};
      ...
      switch (escolha) {
        ...
        case 3 -> limparConsultas();
        default -> System.exit(0);
      }
    }
  }

  private static void limparConsultas() {
    int confirma = JOptionPane.showConfirmDialog(
            null,
            "Tem certeza que deseja limpar todas as consultas?",
            "Limpar Consultas",
    ...
    if (confirma == JOptionPane.YES_OPTION) {
      agenda.clear();
      JOptionPane.showMessageDialog(null, "Todas as consultas foram removidas!");
    }
  }
  ...
  private static void cadastrarConsulta() {
    try {
      ...
      String tipoAtendimento = (String) JOptionPane.showInputDialog(null, "Tipo de atendimento:",
              ...
              new String[]{"Banho", "Tosa", "Banho e Tosa", "Consulta", "Outros"}, "Banho");
