...
public class Main {
    public static void main(String[] args) {
        ...
        agendaVeterinaria agendaVet = new agendaVeterinaria();
        ...
        while (true) {
            ...
            if (opcao == 1) {
                if (agendaVet.agenda.size() >= 10) {
                    JOptionPane.showMessageDialog(null, "Agenda atingiu o limite de consultas");
                }
            }
            if (agendaVet.agenda.size() < 10) {
                if (opcao == 1) {
                    int tipoAnimal = Integer.parseInt(JOptionPane.showInputDialog("Qual a espécie do seu animal?" +
                            "\n1 - Cachorro" +
                            "\n2 - Gato" +
                            "\n3 - Coelho" +
                            "\nNão atendemos outras espécies"));
                    if (tipoAnimal == 1) {
                        String nomeCachorro = JOptionPane.showInputDialog("Qual o nome do seu cachorro?");
                        cachorro.setnome(nomeCachorro);
                        int idadeCachorro = Integer.parseInt(JOptionPane.showInputDialog("Qual a idade do cachorro?"));
                    ...
                    if (opcao2 == 1) {
                        if (tipoAnimal == 1) {
                            ...
                            agendaVet.agenda.add("Um banho agendado para o paciente " + cachorro.nome + "\nAnimal: Cachorro\nRaça: " + cachorro.raca + "\n");
                        }
                        if (tipoAnimal == 2) {
                            JOptionPane.showMessageDialog(null, "Nome: " + gato.nome +
                                    ...
                                    "\nServiço: Banho" +
                                    "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                            agendaVet.agenda.add("Um banho agendado para o paciente " + gato.nome + "\nAnimal: Gato\nRaça: " + gato.raca + "\n");
                        }
                        if (tipoAnimal == 3) {
                            JOptionPane.showMessageDialog(null, "Nome: " + coelho.nome +
                                    ...
                                    "\nServiço: Banho" +
                                    "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                            agendaVet.agenda.add("Um banho agendado para o paciente " + coelho.nome + "\nAnimal: Coelho\nRaça: " + coelho.raca + "\n");
                        }
                    } else if (opcao2 == 2) {
                        if (tipoAnimal == 1) {
                            JOptionPane.showMessageDialog(null, "Nome: " + cachorro.nome +
                                    ...
                                    "\nServiço: Tosa" +
                                    "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                            agendaVet.agenda.add("Uma tosa agendada para o paciente " + cachorro.nome + "\nAnimal: Cachorro\nRaça: " + cachorro.raca + "\n");
                        }
                        if (tipoAnimal == 2) {
                            JOptionPane.showMessageDialog(null, "Nome: " + gato.nome +
                                    "\nIdade: " + gato.idade +
                                    ...
                                    "\nServiço: Tosa" +
                                    "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                            agendaVet.agenda.add("Uma tosa agendada para o paciente " + gato.nome + "\nAnimal: Gato\nRaça: " + gato.raca + "\n");
                        }
                        if (tipoAnimal == 3) {
                            JOptionPane.showMessageDialog(null, "Nome: " + coelho.nome +
                                    "\nIdade: " + coelho.idade +
                                    ...
                                    "\nServiço: Tosa" +
                                    "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                            agendaVet.agenda.add("Uma tosa agendada para o paciente " + coelho.nome + "\nAnimal: Coelho\nRaça: " + coelho.raca + "\n");
                        }
                    } else if (opcao2 == 3) {
                        if (tipoAnimal == 1) {
                            JOptionPane.showMessageDialog(null, "Nome: " + cachorro.nome +
                                    ...
                                    "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                            agendaVet.agenda.add("Uma tosa e banho agendada para o paciente " + cachorro.nome + "\nAnimal: Cachorro\nRaça: " + cachorro.raca + "\n");
                        }
                        if (tipoAnimal == 2) {
                            JOptionPane.showMessageDialog(null, "Nome: " + gato.nome +
                                    "\nIdade: " + gato.idade +
                                    ...
                                    "\nServiço: Tosa e banho" +
                                    "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                            agendaVet.agenda.add("Uma tosa e banho agendada para o paciente " + gato.nome + "\nAnimal: Gato\nRaça: " + gato.raca + "\n");
                        }
                        if (tipoAnimal == 3) {
                            JOptionPane.showMessageDialog(null, "Nome: " + coelho.nome +
                                    "\nIdade: " + coelho.idade +
                                    ...
                                    "\nServiço: Tosa e banho" +
                                    "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                            agendaVet.agenda.add("Uma tosa e banho agendada para o paciente " + coelho.nome + "\nAnimal: Coelho\nRaça: " + coelho.raca + "\n");
                        }
                    } else if (opcao2 == 4) {
                        String sim = "sim";
                        String nao = "nao";
                            ...
                            if (tipoAnimal == 2) {
                                ...
                                if (doencaCat == null) {
                                    ...
                                    JOptionPane.showMessageDialog(null, "Nome: " + gato.nome +
                                            ...
                                            "\nDoença: " + doencaCat +
                                            "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                                    agendaVet.agenda.add("Uma consulta agendada para o paciente " + gato.nome + "\nAnimal: Gato\nRaça: " + gato.raca + "\nDoenca: " + doencaCat + "\n");
                                } else {
                                    JOptionPane.showMessageDialog(null, "Nome: " + gato.nome +
                                            "\nIdade: " + gato.idade +
                                            "\nRaça: " + gato.raca +
                            ...
                            if (tipoAnimal == 3) {
                                ...
                                if (doencaRabbit == null) {
                                    ...
                                    JOptionPane.showMessageDialog(null, "Nome: " + coelho.nome +
                                            ...
                                            "\nDoença: " + doencaRabbit +
                                            "\nPresione 'OK' após confirmar os dados para agendar sua consulta");
                                    agendaVet.agenda.add("Uma consulta agendada para o paciente " + coelho.nome + "\nAnimal: Coelho\nRaça: " + coelho.raca + "\nDoenca: " + doencaRabbit + "\n");
                                } else {
                                    JOptionPane.showMessageDialog(null, "Nome: " + coelho.nome +
                                            "\nIdade: " + coelho.idade +
                                            "\nRaça: " + coelho.raca +
