...
public class Consulta {
    ...
    public Consulta(Animal animal, Atendimento atendimento, String data, String doenca)
        ...
        try {
            ...
            throw new ValidacaoException("Data inválida. Use o formato DD/MM/YYYY.");
        }

        if (atendimento.getTipo().equalsIgnoreCase("Tratamento")) {
            if (doenca == null || doenca.trim().isEmpty()) {
                throw new ValidacaoException("Doença não foi informada");
            }
        }
