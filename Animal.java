public abstract class Animal {
    ...
    public void setNome(String nome) throws ValidacaoException {
        if (nome == null || nome.trim().length() < 2) {
            throw new ValidacaoException("O nome do animal deve ter pelo menos 2 caracteres.");
        }
        this.nome = nome;
    }
    ...
    public void setIdade(int idade) throws ValidacaoException {
        if (idade <= 0) {
            throw new ValidacaoException("A idade do animal deve ser maior que 0.");
        }
        this.idade = idade;
    }
    ...
    public void setRaca(String raca) throws ValidacaoException {
        if (raca == null || raca.trim().isEmpty()) {
            throw new ValidacaoException("A raca do animal deve ser informada.");
        }
        this.raca = raca;
    }
